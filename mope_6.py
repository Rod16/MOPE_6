...
timee = time.time_ns() - start_time
print("Сумарний час роботи роботи у наносекундах: ", timee)
av_time=timee/num
print("Середній час роботи у наносекундах:", av_time)
